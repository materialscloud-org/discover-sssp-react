    ...
    <section>
      ...
      <ul>
        ...
        <li>
          ...
          <br />
          <b>LICENSE:</b> Creative Commons Attribution 3.0 Unported License (CC
          BY 3.0).
        </li>
        <li>
        ...
        <li>
          RE Wentzcovitch: M. Topsakal and R. M. Wentzcovitch, Comput. Mater.
          Sci. 95, 263 (2014)
          <br />
          <b>DOI:</b>{" "}
          <a
      ...
      <ul>
        ...
        <li>
          Separable dual-space Gaussian pseudopotentials: S. Goedecker, M.
          Teter, J. Hutter, Phys. Rev. B 54, 1703 (1996).
          <br />
          <b>DOI:</b>{" "}
          <a
